...
def _naming_model() -> str:
    """Pick the best available model for session naming.

    Prefers a fast/cheap model; falls back to the registry's first available.
    """
    all_names = LLMRegistry.get_all_names()
    for candidate in ["gpt-5.4-nano", "gpt-5-mini", settings.LONG_TERM_MEMORY_MODEL]:
